  ...
  return (
    <>
      <TouchableOpacity
        ...
        disabled={isPending}
        className={cn(
          "flex-row justify-between items-center rounded-lg p-4 mb-3 min-h-16 shadow-sm",
          isFulfilled ? "bg-success" : "bg-secondary",
        )}
      >
        <View className="flex-1 mr-3">
          <Text
            className={cn(
              ...
              isFulfilled ? "text-white" : "text-neutral-700",
            )}
            numberOfLines={2}
            ellipsizeMode="tail"
          >
